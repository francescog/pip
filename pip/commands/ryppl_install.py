import os
from pip.req import RypplInstallRequirement, RequirementSet
...
class RypplInstallCommand(Command):
    name = 'ryppl_install'
    usage = '%prog [OPTIONS] PACKAGE_NAMES...'
    summary = 'Install ryppl packages'
    bundle = False

    def __init__(self):
        super(RypplInstallCommand, self).__init__()
        self.parser.add_option(
            ...
            'cmake). You can run this on an existing directory/checkout (like '
            'pip install -e src/mycheckout). This option may be provided multiple times. '
            'Possible values for VCS are: git (svn, hg and bzr could be added later).')
        self.parser.add_option(
            '-r', '--requirement',
            dest='requirements',
            action='append',
